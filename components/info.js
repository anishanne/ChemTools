                    ...
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                      <div className="mt-2 flex flex-col ">
                        <div className="min-w-full overflow-hidden overflow-x-auto rounded-lg align-middle shadow">
                          <div className="overflow-hidden bg-gray-300 dark:bg-gray-800 shadow sm:rounded-lg">
                            <div className="px-4 py-5 sm:px-6">
                              {" "}
                              <h3 className="text-lg font-bold text-center  leading-6 bg-inherit text-gray-800 dark:text-gray-100">
                                {name} ({symbol}) Stats
                              </h3>
                            </div>
                            <div className="bg-gray-900 border-t  dark:border-gray-900">
                              <dl>
                                <div className="bg-gray-100 dark:bg-gray-700  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                  <dt className="text-sm bg-inherit font-medium text-gray-600 dark:text-gray-50">
                                    Ionization Energies{" "}
                                    <span className="  text-red-500">
                                      (kJ/mol)
                                    </span>
                                  </dt>
                                  <dd className="mt-1 bg-inherit text-sm  text-gray-600 dark:text-gray-50 sm:col-span-2 sm:mt-0 whitespace-normal break-words">
                                    {ionizationString
                                ...
                                <div className="bg-gray-300 dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                  <dt className="text-sm bg-inherit font-medium text-gray-600 dark:text-gray-50">
                                    Electronegativity{" "}
                                    <span className="  text-red-500">
                                      (pauling)
                                  ...
                                  <dd className="mt-1 bg-inherit text-sm text-gray-600 dark:text-gray-50 sm:col-span-2 sm:mt-0">
                                    {electronegativity
                                      ? electronegativity
                                      : "Not Found"}
                                  </dd>
                                ...
                                <div className="bg-gray-300 dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                  <dt className="text-sm bg-inherit font-medium text-gray-600 dark:text-gray-50">
                                    Density{" "}
                                    <span className=" bg-gray-300 dark:bg-gray-800 text-red-500">
                                      (g/cm<sup className="">3</sup>)
                                    </span>
                                  </dt>
                                  <dd className="mt-1 bg-inherit text-sm text-gray-600 dark:text-gray-50 sm:col-span-2 sm:mt-0">
